...
int partiH()
{
    ...
    FILE * fichier = fopen("/Users/Toussaint/Documents/Cours/LC4/Projet/ProjetRC/DerivedData/ProjetRC/Build/Products/Debug/test.txt", "w");
    int victoire = 0;
    int t = 0;
    int a=0;
    int b = 0;
    ...
    for (t=0; t<2000; t++) {
        ...
        while (!victoire) {
            
            {
                ...
                //printf("\n%s\n",coupPossible->proto);
                if(action(grille, coupPossible->proto, pere)){
                    printf("efef");
                    a++;
                    victoire = 1;
                    break;
